...
REM
REM Generated by Vivado on Thu Sep 18 23:31:56 -0400 2025
...
echo "xvlog --incr --relax -prj wallace_8x8_tb_vlog.prj"
call xvlog  --incr --relax -prj wallace_8x8_tb_vlog.prj -log xvlog.log
